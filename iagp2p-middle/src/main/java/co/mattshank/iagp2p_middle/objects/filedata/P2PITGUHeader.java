...
public class P2PITGUHeader extends P2PFileReader implements P2PFileHeaderInterface {
	String header;
	int fromAgencyID;
	...
	public P2PITGUHeader(String header) throws IOException, ParseException {
		this.header = header;
